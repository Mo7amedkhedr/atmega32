...
u8 readPort(u8 portNumber) {
	// Select the port using the port number
	switch (portNumber) {
		case 0: return PINA; // Read from Port A
		case 1: return PINB; // Read from Port B
		case 2: return PINC; // Read from Port C
		case 3: return PIND; // Read from Port D
